...
from selfdrive_msgs.msg import SystemState as SystemStateMsg, DeviceState as DeviceStateMsg, Performance, Log
from selfdrive_msgs.srv import SetDeviceState, SetSystemState
import sty
import time
import inspect
...
class Node(RclpyNode):
    def __init__(self, name: str) -> None:
        ...
        self.set_device_state_client = self.create_client(SetDeviceState, "/selfdrive/shared/set_device_state")
        self.set_system_state_client = self.create_client(SetSystemState, "/selfdrive/shared/set_system_state")
